...
For the convolutional neural network, we use contrast-normalized pixels, but also compare an extended dataset to the provided examples. We double the size of the training set by introducing a randomly rotated version of each example.
