...
class ConvNet(object):
	...
	def __init__(self, rng, 
		...
		# print next_layer_input.shape.eval()
		...
		updates = gradient_updates_momentum(cost=self.dropout_nll(y), params=self.params, learning_rate=learning_rate, momentum=0.9)
