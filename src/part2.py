...
test_data = scaler.transform(test_input)
# ----------------
# Loading test set
# ----------------
# print "Loading test input..."
# test_data = loadnp("/Users/stephanielaflamme/Desktop/Numpy sets/test_inputs_standardized.npy")

# ------------------------
# Getting test predictions
# ------------------------
print 'Getting test predictions'
classifier = NeuralNet(layers= [2304, 25, 10], alpha=0.01, epochs=20)
